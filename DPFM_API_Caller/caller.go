...
import (
	...
	"data-platform-api-participation-cancels-rmq-kube/config"
...
func (c *DPFMAPICaller) headerCancel(
	...
	res, err := c.rmq.SessionKeepRequest(nil, c.conf.RMQ.QueueToSQL()[0], map[string]interface{}{"message": header, "function": "ParticipationHeader", "runtime_session_id": sessionID})
	if err != nil {
